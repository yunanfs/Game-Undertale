...
<head>
    ...
    <title>Edit Character - UNDERTALE Admin</title>
...
<body>
    ...
    <div class="top-navbar">
        <div class="navbar-logo">★ EDIT CHARACTER ★</div>
            ...
            <form method="POST" action="">
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="role" name="role" value="<?php echo htmlspecialchars($character['role']); ?>">
                    </div>
                </div>
                
                <div class="form-group">
                    <label for="description">DESCRIPTION</label>
                    <input type="text" id="description" name="description" value="<?php echo htmlspecialchars($character['description']); ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="bio" name="bio"><?php echo htmlspecialchars($character['bio']); ?></textarea>
                </div>
