...
<body>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <a href="#" onclick="return openDeleteModal('story_delete.php?id=<?php echo $story['id']; ?>');" class="btn-delete">DELETE</a>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach; ?>
    ...
    <div class="logout-modal-overlay" id="deleteModalOverlay">
        <div class="logout-modal-content">
            <div class="logout-modal-icon">⚠</div>
            <h2>DELETE STORY?</h2>
            <p>Are you sure you want to<br>delete this story?</p>
            <div class="logout-modal-buttons">
