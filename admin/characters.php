...
// Get all characters
$result = mysqli_query($conn, "SELECT * FROM characters ORDER BY name ASC");
$characters = [];
if ($result) {
...
<head>
    ...
    <title>Manage Characters - UNDERTALE Admin</title>
...
<body>
    ...
    <div class="top-navbar">
        <div class="navbar-logo">★ CHARACTERS MANAGEMENT ★</div>
    ...
    <div class="container">
        <div class="header">
            ...
            <p style="font-size: 0.7rem; color: #aaa; margin: 0;">Total: <?php echo count($characters); ?> characters</p>
        </div>

        <a href="character_add.php" class="btn-add">★ ADD NEW CHARACTER ★</a>
                ...
                <tbody>
                    <?php foreach ($characters as $index => $character): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars(substr($character['description'], 0, 50)) . '...'; ?></td>
                            <td>
                                <div class="action-buttons">
                                    <a href="character_edit.php?id=<?php echo $character['id']; ?>" class="btn-edit">EDIT</a>
                                    <a href="#" onclick="return openDeleteModal('character_delete.php?id=<?php echo $character['id']; ?>');" class="btn-delete">DELETE</a>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach; ?>
        ...
        <?php else: ?>
            <div class="empty-message">
                No characters found. <a href="character_add.php" style="color: #0f0;">Create the first character</a>
            </div>
        <?php endif; ?>
    </div>
    ...
    <div class="logout-modal-overlay" id="deleteModalOverlay">
        <div class="logout-modal-content">
            ...
            <p>Are you sure you want to<br>delete this character?</p>
            <div class="logout-modal-buttons">
