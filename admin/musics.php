...
// Get all music
$result = mysqli_query($conn, "SELECT * FROM music ORDER BY order_number ASC");
$musics = [];
if ($result) {
...
<head>
    ...
    <title>Manage Music - UNDERTALE Admin</title>
...
<body>
    ...
    <div class="top-navbar">
        <div class="navbar-logo">★ MUSIC MANAGEMENT ★</div>
    ...
    <div class="container">
        <div class="header">
            <h1>MANAGE MUSIC</h1>
            <p style="font-size: 0.7rem; color: #aaa; margin: 0;">Total: <?php echo count($musics); ?> tracks</p>
        </div>

        <a href="music_add.php" class="btn-add">★ ADD NEW TRACK ★</a>
                ...
                <tbody>
                    <?php foreach ($musics as $index => $music): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($music['file_path']); ?></td>
                            <td><?php echo $music['order_number']; ?></td>
                            <td>
                                <div class="action-buttons">
                                    <a href="music_edit.php?id=<?php echo $music['id']; ?>" class="btn-edit">EDIT</a>
                                    <a href="#" onclick="return openDeleteModal('music_delete.php?id=<?php echo $music['id']; ?>');" class="btn-delete">DELETE</a>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach; ?>
        ...
        <?php else: ?>
            <div class="empty-message">
                No music found. <a href="music_add.php" style="color: #0f0;">Add the first track</a>
            </div>
        <?php endif; ?>
    </div>
    ...
    <div class="logout-modal-overlay" id="deleteModalOverlay">
        <div class="logout-modal-content">
            <div class="logout-modal-icon">⚠</div>
            <h2>DELETE TRACK?</h2>
            <p>Are you sure you want to<br>delete this track?</p>
            <div class="logout-modal-buttons">
