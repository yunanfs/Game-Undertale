...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title) || empty($content)) {
        ...
        $stmt = $conn->prepare("UPDATE stories SET title = ?, description = ?, content = ?, order_number = ? WHERE id = ?");
...
<head>
    ...
    <title>Edit Story - UNDERTALE Admin</title>
...
<body>
    ...
    <div class="top-navbar">
        <div class="navbar-logo">★ EDIT STORY ★</div>
        ...
        <div class="form-container">
            ...
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="description" name="description" value="<?php echo htmlspecialchars($story['description']); ?>">
                </div>
                
                <div class="form-group">
                    <label for="order_number">ORDER NUMBER</label>
                    <input type="number" id="order_number" name="order_number" min="0" value="<?php echo $story['order_number']; ?>">
                </div>
